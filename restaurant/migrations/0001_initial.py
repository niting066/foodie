# Generated by Django 3.0 on 2020-04-16 12:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('admin_module', '0006_auto_20200416_1815'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restro_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_module.AreaModel')),
                ('restro_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_module.RestaurantTypeModel')),
            ],
        ),
    ]
